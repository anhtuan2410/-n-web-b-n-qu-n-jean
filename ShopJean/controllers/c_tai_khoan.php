				...
				if(!empty($ten_dang_nhap) && !empty($email) && !empty($email)){
					if($pass_1 = $pass_2)
					{
						...
						if($tai_khoan > 0)
						{
							...
							$mail->MsgHTML("Bạn hãy nhấp vào link sau để trở thành, thành viên của Fashion EveryOne <br> http://localhost/DemoSmarty/xac_nhan_tai_khoan.php?ten_dang_nhap=$ten_dang_nhap");
