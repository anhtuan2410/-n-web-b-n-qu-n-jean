...
class C_loai_bai_viet
{
	...
	function Them_loai_bai_viet()
	{
			...
			if(isset($_POST["btnCapnhat"]))
			{
				...
				$kq=$m_loai_bai_viet->Them_loai_bai_viet($ma_loai_bai_viet, $ten_loai_bai_viet, $mo_ta, $ma_loai_cha);
				if($kq)
				{
	...
	{		
			...
			if(isset($_POST["btnCapnhat"])){
				...
				$kq=$m_loai_bai_viet->Sua_loai_bai_viet_theo_ma_bai_viet($ten_loai_bai_viet, $mo_ta, $ma_loai_cha,$ma_loai_bai_viet);
				if($kq)
				{
