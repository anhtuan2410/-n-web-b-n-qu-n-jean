      ...
      <div class="col-md-6">
        <form action="dang_ky_thanh_cong.php" method="post">
          ...
          <!-- $gioi_tinh , $so_dien_thoai, $dia_chi-->
            ...
            <div class="row">
              <div class="col-sm-12">
                <input type="text" class="custom-form" name="txtHoTen" placeholder="Họ và tên" />
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <input type="text" class="custom-form" name="txtTenDangNhap" id="txtTenDangNhap" onkeyup="Timmonan(this.value)" placeholder="Tên đăng nhập" />
                <div id="kq"></div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <input class="custom-form" type="email" name="txtEmail" id="txtEmail" placeholder="Email" />
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <input class="custom-form" type="text" name="txtSoDienThoai" placeholder="Số Điện Thoại" />
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <input class="custom-form" type="text" name="txtGioiTinh" placeholder="Giới Tính" />
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-sm-12">
                <input class="custom-form" type="password" id="txtPassword1" name="txtPassword1" placeholder="Mật khẩu" />
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <input class="custom-form" type="password" id="txtPassword2" name="txtPassword2" placeholder="Nhập lại mật khẩu" />
                <div id="kq2"></div>
              </div>
            </div>
            <div class="row">	
              <div class="col-sm-6">
                <input type="submit" class="custom-form custom-submit no-margin" name="dangKy" value="Đăng ký" />
              </div>
            </div>
