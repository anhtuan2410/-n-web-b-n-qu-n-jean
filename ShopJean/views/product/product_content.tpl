        ...
        <div class="row">
            <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="single-product-tab-content">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="img-three"> <img src="images/{$san_pham->hinh}" alt="" />
                            <a href="images/{$san_pham->hinh}" data-lightbox="roadtrip" data-title="Ảnh"> <span class="view-full-screen"><i class="sp-full-view"></i> view full screen</span> </a>
                        </div>
                        <div role="tabpanel" class="tab-pane" id="img-four"> <img src="images/{$san_pham->hinh}" alt="" />
                            <a href="images/{$san_pham->hinh}" data-lightbox="roadtrip" data-title="Ảnh"> <span class="view-full-screen"><i class="sp-full-view"></i> view full screen</span> </a>
                        </div>
                    </div>
                    <!-- Nav tabs -->
            ...
            <div class="col-md-7 col-sm-7 col-xs-12">
                <div class="single-product-description">
                    ...
                    <div class="pro-color"> <span>Color</span>
